                    ...
                    <div class="subdivision"><br>
                        ...
                        <?php while($row = mysqli_fetch_array($val)):?>
                                ...
                                <tr>
                                    <td><br>&nbsp;&nbsp;&nbsp;&nbsp;Name</td>
                                    <td><br>&nbsp;:&nbsp;&nbsp;&nbsp;</td>
                                    <td><br><?php echo $row['firstname']?>&nbsp;<?php echo $row['lastname']?></td>
                                    <td><br>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;Phone</td>
                                ...
                                <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;Time</td>
                                    <td>&nbsp;:&nbsp;&nbsp;&nbsp;</td>
                                    <td><?php echo $row1['RequestedDate']; ?></td>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;Crowd</td>
                                    <td>&nbsp;:&nbsp;&nbsp;&nbsp;</td>
                                    <td><?php echo $row1['people']; ?></td>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;Status</td>
                                ...
                                <tr>
                                    <td colspan="4"><center><hr style="width:100px;"></center></td>
