        ...
        <div class="container">
            <form method="post">
                ...
                <div class="subdivision"><br>
                    <img src="user.png" width="130px" class="pics">
                    <h2 style="font-family:'Quicksand',sans-serif; font-size:22px;font-weight: bolder;color:white;">Login to Crowd Analysis</h2><br>
                    <input type="text" placeholder="email" required name="user" class="in"><br><br>
                    <input type="password" placeholder="password" required name="pass" class="in"><br><br>
                    <button type="submit" name="send" class="io">Login</button><br>&nbsp;<!--Change Type-->
