...
$vehicle=htmlspecialchars($_POST['password']);
$email=htmlspecialchars($_POST['email12']);
$phone=htmlspecialchars($_POST['phn']);
$sql="insert into user(firstname, lastname, password, email, phone) values ('$fname','$lname','$vehicle','$email','$phone');";
echo $sql;
    $val=$db->query($sql);
    if($val==true)
    {
        ...
        <div class="container">
            <form method="post">
                ...
                <div class="subdivision"><br>
                    <img src="user.png" width="120px" class="pics">
                    ...
                    <input type="password" placeholder="password" required name="password" class="in"><br><br>
                    ...
                    <button type="submit" name="send"  class="io" >Sign Up</button><br>&nbsp;
